...
## Алгоритм DBScan:
 ...
 ```
 # Открытие файла и 'холостой' проход 1 строчки(ВАЖНО: если у вас в файлах есть строчка 'x     y', тогда .readline() у файлов обязателен, если нет - НЕ ИСПОЛЬЗОВАТЬ .readline())
...
# ===============================
 ...
 `(Используется, когда в условии прямо говорится о том, что центроид - это ср.ариф. точек)`
