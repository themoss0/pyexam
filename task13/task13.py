...
def task13_23559_13():  # 718
    ip = ip_network('102.162.200.51/255.255.255.0', 0)
    print(list(ip.hosts())[-1])
    print(102+162+200+254)


def task13_23751_14(): # 191.191.255.254 -> 191191255254
